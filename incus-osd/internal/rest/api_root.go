...
//	          example: {"environment":{"hostname":"af94e64e-1993-41b6-8f10-a8eebb828fce","machine_id":"af94e64e199341b68f10a8eebb828fce","os_name":"IncusOS","os_version":"202511041601","os_version_next":"202511152230","os_version_other":"202511162345","system_is_ready":true,"uptime":"3237039"}}
func (s *Server) apiRoot10(w http.ResponseWriter, r *http.Request) {
	...
	var osVersionOther string

	ukiVersions, ukiErr := util.GetUKIVersions()
	if ukiErr == nil {
		osVersionOther = ukiVersions.OtherVersion
	}
	...
	resp := map[string]any{
		"environment": map[string]any{
			...
			"os_version_other": osVersionOther,
