...
//	          example: {"interfaces":[{"name":"enp5s0","addresses":["dhcp4"],"required_for_online":"yes","hwaddr":"10:66:6a:1a:20:0f","lldp":true}],"timezone":"America/New_York"}
//	responses:
//	  "200":
...
func (s *Server) apiSystemNetwork(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodGet:
		...
		if s.state.System.Network.Config.Timezone == "" {
			s.state.System.Network.Config.Timezone = "UTC"
		}
