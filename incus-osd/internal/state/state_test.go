...
func TestCustomEncoding(t *testing.T) {
	...
	for _, goldVersion := range []string{goldEncodingV0, goldEncodingV1, goldEncodingV2, goldEncodingV3, goldEncodingV4, goldEncodingV5, goldEncodingV6, goldEncodingV7, goldEncodingV8} {
		var s state.State
		...
		require.Equal(t, goldEncodingV9, string(content))
