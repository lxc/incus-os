...
func TestParseRoutes(t *testing.T) {
	...
	routes := parseRouteCommandOutput(`default via 198.51.100.1 proto static onlink
10.0.0.0/8 via 192.0.2.1 proto static
`)

	require.Len(t, routes, 2)
	require.Equal(t, api.SystemNetworkRoute{
		To:     "default",
		Via:    "198.51.100.1",
		OnLink: true,
	}, routes[0])
