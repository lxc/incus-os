...
Use the **OpenStack CLI** and your credentials to upload the converted image:
...
2. Access the **OpenStack Console** in your browser to monitor the boot process.
3. Once the system is ready, follow the **[access instructions](../access.md)** to log in.
