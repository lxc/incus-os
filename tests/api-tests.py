...
old_image_img = os.path.join(os.getcwd(), "IncusOS_202510172028.img")
image_img = os.path.join(os.getcwd(), "IncusOS_202510172129.img")
image_iso = os.path.join(os.getcwd(), "IncusOS_202510172129.iso")
